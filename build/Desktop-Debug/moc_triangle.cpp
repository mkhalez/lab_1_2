...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Triangle_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Triangle_t qt_meta_stringdata_Triangle = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_Triangle[] = {
...
Q_CONSTINIT const QMetaObject Triangle::staticMetaObject = { {
    ...
    qt_meta_stringdata_Triangle.offsetsAndSizes,
