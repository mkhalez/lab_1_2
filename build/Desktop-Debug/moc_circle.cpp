...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Circle_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Circle_t qt_meta_stringdata_Circle = {
    {
        QT_MOC_LITERAL(0, 6)   // "Circle"
    },
    "Circle"
};
...
Q_CONSTINIT static const uint qt_meta_data_Circle[] = {
...
Q_CONSTINIT const QMetaObject Circle::staticMetaObject = { {
    ...
    qt_meta_stringdata_Circle.offsetsAndSizes,
    qt_meta_data_Circle,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_Circle_t,
        // Q_OBJECT / Q_GADGET
