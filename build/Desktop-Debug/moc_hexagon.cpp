...
namespace {
struct qt_meta_stringdata_Hexagon_t {
    uint offsetsAndSizes[2];
    char stringdata0[8];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Hexagon_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Hexagon_t qt_meta_stringdata_Hexagon = {
    {
        QT_MOC_LITERAL(0, 7)   // "Hexagon"
    },
    "Hexagon"
};
...
Q_CONSTINIT static const uint qt_meta_data_Hexagon[] = {
...
Q_CONSTINIT const QMetaObject Hexagon::staticMetaObject = { {
    ...
    qt_meta_stringdata_Hexagon.offsetsAndSizes,
    qt_meta_data_Hexagon,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_Hexagon_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<Hexagon, std::true_type>
    >,
    nullptr
} };
...
void *Hexagon::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Hexagon.stringdata0))
