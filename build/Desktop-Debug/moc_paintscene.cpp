...
Q_CONSTINIT static const qt_meta_stringdata_PaintScene_t qt_meta_stringdata_PaintScene = {
    {
        ...
        QT_MOC_LITERAL(29, 0),  // ""
        QT_MOC_LITERAL(30, 16),  // "perimeterChanged"
        QT_MOC_LITERAL(47, 9),  // "perimeter"
...
void PaintScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->perimeterChanged((*reinterpret_cast< std::add_pointer_t<double>>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (PaintScene::*)(double );
            if (_t _q_method = &PaintScene::perimeterChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void PaintScene::perimeterChanged(double _t1)
{
